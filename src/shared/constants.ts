export class Constants {
  ...
  public static readonly MAIL_ITEM_CAPACITY_SOON_EXCEED = `Bonjour, 
        Vous venez d'enregistrer votre ${
          Constants.ITEM_NUMBER_TO_SEND_MAIL +
            Constants.ITEM_NUMBER_TO_SEND_MAIL ===
          1
            ? 'er'
            : 'ème'
  ...
  public static readonly ERROR_MSG_USER_ALREADY_HAVE = `L'utilisateur a déjà une todolist`;
  public static readonly ERROR_MSG_LIMIT_BETWEEN_ITEM_CREATION = `La dernière création d'item remonte à moins de ${
    180000 / Constants.LIMIT_BETWEEN_CREATION
  } minutes.`;
}
